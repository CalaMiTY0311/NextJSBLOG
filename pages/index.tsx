  ...
  return (
    <>
      ...
      <section className="my-10">
        <h1 className="font-bold text-2xl sm:text-4xl font-mono">🧑🏻‍💻 DEV MiTY</h1>
      </section>
      <section className="flex justify-center gap-8 items-center flex-wrap">
        ...
        <div className="min-w-[250] max-w-[300px]">
          <h2 className="font-bold text-xl">꿈꾸는 개발자 김준호 입니다.</h2>
          <br />
          <p>어제를 후회하지않게 노력하고</p>
          <p>다짐이 아닌 먼저 행동으로</p>
          <div className="flex gap-5 items-center mt-4">
            <a
              href="OracleMemory2@gmail.com"
            ...
            <a
              href="https://github.com/CalaMiTY0311"
